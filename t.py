...
class Model:
    ...
    def predict(self, model_input: Any, max_length=100, do_sample=True, top_p=0.95, top_k=4, temperature=0.2, num_return_sequences=1) -> str:
        ...
        y = self._model.module.generate(x.cuda(), max_length=max_length, do_sample=do_sample, top_p=top_p, top_k=top_k, temperature=temperature, num_return_sequences=num_return_sequences, eos_token_id=self._tokenizer.eos_token_id)
